...
#show: project.with(
  ...
  abstract: [
    We present a novel /*TODO maybe advanced/generic instead of advances??*/ implementation of the forward mode automatic differentiation algorithm written in Rust, named #diff-package. This package enables the computation of derivatives of any order and for any number of variables efficiently. We analyze various approaches to AD and propose an implementation designed for ease of extension and optimization.
  ],
)
